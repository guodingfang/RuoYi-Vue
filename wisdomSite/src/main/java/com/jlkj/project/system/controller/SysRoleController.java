...
public class SysRoleController extends BaseController
{
    ...
    @ApiOperation("角色设置-角色列表")
    @ApiImplicitParam(name = "role", value = "角色实体", dataType = "SysRole")
