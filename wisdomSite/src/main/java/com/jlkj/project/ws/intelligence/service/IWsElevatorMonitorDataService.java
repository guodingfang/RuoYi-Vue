 ...
 * @date 2020-07-03
 */
public interface IWsElevatorMonitorDataService {
     ...
     **/
    WsElevatorMonitorDataVO findWsElevatorMonitorDataBySerialNumber(WsElevatorMonitorData wsElevatorMonitorData);
}
