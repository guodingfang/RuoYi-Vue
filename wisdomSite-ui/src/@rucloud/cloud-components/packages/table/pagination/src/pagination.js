      ...
      render(h) {
        return (
          <button
            type="button"
            class="btn-prev"
            style={{ margin: '2px 0', 'min-width': '24px' }}
    ...
    Jumper: {
      ...
      methods: {
        ...
        handleChange(value) {
          ...
          this.$parent.internalCurrentPage = this.$parent.getValidCurrentPage(this.userInput);
      ...
      render(h) {
        return (
          <span class="el-pagination__jump">
            ...
            <el-button vOn:click={this.handleChange} class={'btn'}>
              确定
            </el-button>
          </span>
        );
