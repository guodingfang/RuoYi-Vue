<template>
  <section>
    ...
    <div class="card-ecarts">
      <v-chart style="width: 100%;height: 342px" ref="rt" :options="Toptions" autoresize />
      <v-chart style="width: 100%;height: 342px" ref="rt" :options="Boptions" autoresize />
    </div>
  </section>
</template>
<script>
