    ...
    methods: {
      getLtData() {
        ...
        driverBadP(reqData).then(res => {
          ...
          this.ltOptions.series[0].data = res.data.map(e => e.alarmingNumber||0);
          this.ltOptions.series[1].data = res.data.map(e => (e.alarmingNumber/e.totalNumber)*100);
        })
      },
      getRtData() {
        deviceAlarmP({ ...this.queryParams, projectId: this.projectId }).then(res => {
          this.rtOptions.xAxis[0].data = _.map(res.data, 'driverName');
          this.rtOptions.series[0].data = res.data.map(e => e.preAlarmingNumber||0);
          this.rtOptions.series[1].data = res.data.map(e => e.alarmingNumber||0);
          this.lbOptions.xAxis[0].data = _.map(res.data, 'driverName');
          this.lbOptions.series[0].data = res.data.map(e => e.totalWeight||0);
          this.lbOptions.series[1].data = res.data.map(e => e.totalNumber||0);
          this.rbOptions.xAxis[0].data =  res.data.map(e => e.driverName);
          this.rbOptions.series[0].data =  res.data.map(e => e.totalHour||0);
          this.rbOptions.series[1].data =  res.data.map(e => e.totalNumber||0);
