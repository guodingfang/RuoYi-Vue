    ...
    methods: {
      getEquipAnaE() {
        getEquipAnaE(this.queryParams).then(res => {
           ...
           */
          // this.ltOptions.series[0].data = _.map(res.data, 'towerCraneEquipmentNum');
          // this.ltOptions.series[1].data = _.map(res.data, 'towerCraneMonitoringEquipmentNum');
          // this.ltOptions.series[2].data = _.map(res.data, 'monitoringOnlineRate');
