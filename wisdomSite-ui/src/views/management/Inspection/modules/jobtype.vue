        ...
        <el-table-column label="操作" align="left">
          <template slot-scope="scope">
            <span
              ...
              >编辑</span
            >
            <span class="jl-green mr10 pointer" @click="deleteFn(scope.row.id)"
              >删除</span
            >
          </template>
        </el-table-column>
    ...
    >
      ...
      >
        ...
        >
          <el-input
            type="operationName"
            v-model.number="ruleForm.operationName"
            autocomplete="off"
          ></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button class="r_button" @click="innerVisible = false"
          >取消</el-button
        >
        <el-button
          type="primary"
