<template>
  <el-dialog title="新增项目" :visible.sync="flag" width="900px" @close="closeDialog" :close-on-click-modal="false">
    <div class="overview-wrap">
      <el-form ref="projectForm" :model="projectForm" :rules="rules" size="small" label-width="140px">
        ...
        <el-form-item label="地图位置：" prop="latitude">
          <div class="map-wrap">
            <div id="result">
              <input type="text" class="el-input" id="suggestId" size="20" value="" style="width:250px;"/></div>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button size="small" type="primary" @click="addProject()">保 存</el-button>
      </div>
    </div>
  </el-dialog>
</template>
      ...
      initMapData() {
        ...
        this.$nextTick(() => {
          ...
          ac.addEventListener("onconfirm", function (e) { //鼠标点击下拉列表后的事件
            ...
            _this.projectForm.projectAddress =  myValue;
