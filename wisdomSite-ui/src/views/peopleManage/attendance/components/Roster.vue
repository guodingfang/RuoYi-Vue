  ...
  <div class="access-wrap">
    <div class="query-box">
      <el-select
        ...
        clearable
      >
        <el-option label="建筑工人花名册" :value="0" />
        <el-option label="管理人员花名册" :value="1" />
      </el-select>
      <el-select
        placeholder="项目名称"
...
<script>
  ...
  export default {
    ...
    data() {
      return{
        tableConfig: [
          { prop: 'personStatusName', label: '状态', width: ''},
          { prop: 'name', label: '姓名' },
    ...
    methods: {
      ...
      /** 查询 列表 */
      getRosterList() {
        getRosterList(this.queryParams).then(response => {
